...
$tests = @(
    ...
    'Test-ReferenceModArchaeology.ps1',
    ...
    'Test-BiologyDetailPostMountVisibility.ps1',
    'Test-BiologyBackTransition.ps1',
    'Test-BiologyE3PreferencePlacement.ps1',
    ...
    'Test-E3PresentationRecovery.ps1',
