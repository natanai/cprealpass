...
if ($doc -notmatch 'Launcher-OFF runtime audit' -or $doc -notmatch 'may still load' -or $doc -notmatch 'Native observations and final local evidence' -or $doc -notmatch '#152') { throw 'Player disable/uninstall documentation lost runtime audit or honest native/local evidence boundaries.' }
