...
foreach ($needle in @('MinimapContainerController','IronsightGameController','QuestTrackerGameController','WeaponRosterGameController','HotkeysWidgetController','gameuiCrosshairContainerController','interactionWidgetGameController','activityLogEntryLogicController','NpcNameplateGameController','NameplateVisualsLogicController','OnInitialize','OnScreenProjectionUpdate','SetElementVisibility','IsAnyElementVisible','OnUpdateInteraction','SetText','c_DisplayRangeNotAggressive','c_MaxDisplayRangeNotAggressive')) {
