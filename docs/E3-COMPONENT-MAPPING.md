...
`native NPCNextToTheCrosshair / discovered identity -> native SetVisualData unchanged -> native visibility/content -> Biology presentation fallback only when native name remains empty`.
