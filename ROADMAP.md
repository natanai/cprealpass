...
- Local gates passed at source checkpoint `cf1bc0994cfc`: all 88 CI suites, 65-source exact compile, 86-file ZIP inventory, upgrade/reinstall/uninstall/clean reinstall, REDmod deployment and startup with/without its official modded flag. Version is promoted to 1.0.0. Final PR/CI/merge and the rebuilt merged-source installed receipt are reconciled in the final release handoff.
